...
class _SelectCompteState extends State<SelectCompte> {
  ...
  final _baseUrl = '${PubCon.cheminApi}fetch_categorie_Taxe2/';
...
//Perform search
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Select Catégorie Taxe'),
        ),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: InkWell(
                          ...
                          child: ListTile(
                            title: Text(_posts[index]['designation']),
                            subtitle: Text(""),
                            trailing: IconButton(
                              ...
                              onPressed: () {
                                ...
                                if (Navigator.canPop(context)) {
                                  Navigator.pop(
                                      context, PubCon.DesignationCompte);
                                } else {
                                  SystemNavigator.pop();
                                }
                              },
