                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, index) => Card(
                        ...
                        child: InkWell(
                          onTap: () {
                            setState(() {
                              PubCon.refEnteteVente = _posts[index]['id'];
                              PubCon.nomClient = _posts[index]['noms'];
                              PubCon.montantVente =
                                  "${_posts[index]['RestePaie']}";
                            });

                            if (Navigator.canPop(context)) {
                              Navigator.pop(context, PubCon.livraison);
                            } else {
                              SystemNavigator.pop();
                            }
                          },
                          child: ListTile(
                            ...
                            subtitle: Text(
                                "${_posts[index]['livraison']}\nMontant: ${_posts[index]['RestePaie']}"),
                            trailing: IconButton(
